...
public class EventNotification {
    ...
    public static void notify(final Context context,
                              final String magasinName, final String content) {
        ...
        final String title = "Un évènement de " + magasinName + " va commencer !";
                ...
                .addAction(
                        ...
                        PendingIntent.getActivity(
                                ...
                                Intent.createChooser(new Intent(Intent.ACTION_SEND)
                                        .setType("text/plain")
                                        .putExtra(Intent.EXTRA_TEXT, "Dummy text"), "CAP SOPHIA"),
                                PendingIntent.FLAG_UPDATE_CURRENT))
                .addAction(
                        R.drawable.ic_action_stat_reply,
                        res.getString(R.string.action_reply),
                        PendingIntent.getActivity(context, 0, new Intent(context, TrajetActivity.class), 0))
