...
public class CapSophia {
    ...
    static {
        Magasin e = new Magasin(0, "H&M Homme", Collections.singletonList(MagasinType.HOMME), "H&M saura vous dénicher le meilleur prix pour vos chaussures");
        magasins.add(
                e
        );
        magasins.add(new Magasin(1, "Suwway Restauration", Arrays.asList(MagasinType.FEMME, MagasinType.ENFANT, MagasinType.HOMME), "Créez votre plat de pâtes ou pizza personnalisé",R.drawable.subway_icon));
